    ...
    extend: {
      ...
      colors: {
        ...
        accent: {
          ...
          gradient: {
            start: "hsl(var(--accent-gradient-start))",
            end: "hsl(var(--accent-gradient-end))",
          },
        },
        glass: {
          bg: "hsl(var(--glass-bg))",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--accent-gradient-start) / 0.3)"
          },
          "50%": {
            boxShadow: "0 0 40px hsl(var(--accent-gradient-start) / 0.5)"
          }
        },
        "slide-in-left": {
          "0%": {
